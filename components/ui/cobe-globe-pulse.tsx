...
interface GlobePulseProps {
  ...
  className?: string;
  speed?: number;
  /** Colore dei pulse marker (rings + dot) */
  pulseColor?: string;
}
  ...
  useEffect(() => {
    ...
    function init() {
      ...
      globe = createGlobe(canvas, {
        ...
        mapBrightness: 7,
        // Colori WIDER
        baseColor: [0.16, 0.32, 0.22], // verde
        markerColor: [0.49, 0.78, 0.86], // azzurro
        glowColor: [0.92, 0.9, 0.83], // panna
        markerElevation: 0,
        markers: markers.map((m) => ({ location: m.location, size: 0.025, id: m.id })),
        arcs: [],
        arcColor: [0.49, 0.78, 0.86],
        arcWidth: 0.5,
        arcHeight: 0.25,
        opacity: 0.85,
      });
        ...
        >
          ...
          <span
            style={{
              ...
              borderRadius: "50%",
              boxShadow: `0 0 0 3px #FFFDF4, 0 0 0 5px ${pulseColor}`,
            }}
          />
        </div>
      ))}
