            ...
            {items.map((item, i) => {
              ...
              return (
                <motion.div
                  key={item.id}
                  className={cn(
                    "absolute bottom-0 rounded-2xl border border-black/10 overflow-hidden shadow-xl",
        ...
        <div className="mt-6 flex items-center justify-center gap-3">
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    on ? "bg-wider-dot-active w-6" : "bg-wider-dot-inactive hover:bg-wider-dot-hover",
                  )}
          ...
          {activeItem.href && (
            <Link
              ...
              target="_blank"
              rel="noreferrer"
              className="text-wider-dot-inactive hover:text-wider-dot-active transition"
  ...
  return (
    <div className="relative h-full w-full">
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-5">
        <div className="truncate text-lg font-semibold text-white tracking-wide" style={{ fontFamily: "'Playfair Display', serif" }}>
          {item.title}
        </div>
        {item.description && (
          <div className="mt-1 line-clamp-2 text-sm" style={{ color: "rgba(255,253,244,0.75)" }}>
            {item.description}
          </div>
        )}
      </div>
