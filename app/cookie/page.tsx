...
const URLS = {
  it: "https://app.legalblink.it/api/documents/6a2f270b0000de0029a6d9de/cookie-policy-it",
  en: "https://app.legalblink.it/api/documents/6a2f270b0000de0029a6d9de/cookie-policy-en",
};
  ...
  return (
    <>
      ...
      <div className="pp-iframe-wrap">
        <iframe src={URLS[lang]} title="Cookie Policy" />
      </div>
    </>
  );
}
